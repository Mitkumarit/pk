            ...
            <div class="ins-box">
                <form method="post" id="video-ins">
                    <div class="form-row justify-content-center">
                        <span class="form-group col-sm-12 col-lg-6 mb-0">
                            <input type="text"  class="form-control" id="video_code" placeholder="                                                                                             Enter Youtube Video URL" align="center">
</span>
                        <span class="form-group col-sm-12 col-lg-2 mb-0">
                            <input type="submit" value="UPLOAD"  class="btn btn-outline" data-toggle="modal"
                                data-target="#exampleModalCenter"></input>
</span>
                    </div>
                </form>
            </div>
