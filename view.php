<?php $active = "video gallary" ?>
<?php include  "header.php"; ?><br>
<h5>
        <font color="red" bgcolor="green">
            <marquee> નોંધ: આ પેજ પર તમને અવનવાં વિડીયો તથા કાઉન્સિલ પ્રોગ્રામના લેટેસ્ટ માહિતી મળી રહેશે.</marquee>
        </font>
    </h5>
<?php
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <ul class="nav justify-content-center bg-dark">
                <li class="nav-item">
                    <div class="nav-link heading">Video Gallery</div>
                </li>
            </ul>
        </div>
